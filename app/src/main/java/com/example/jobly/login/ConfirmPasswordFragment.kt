 ...
 */
class ConfirmPasswordFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<View>(R.id.continue_confirm_password)?.setOnClickListener(this)

    }

    override fun onClick(v: View) {
        nav?.navigate(R.id.action_confirmPasswordFragment_to_aboutYouFragment)
    }
