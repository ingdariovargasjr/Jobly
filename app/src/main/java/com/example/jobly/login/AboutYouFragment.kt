 ...
 */
class AboutYouFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<View>(R.id.continue_about_you)?.setOnClickListener(this)

    }

    override fun onClick(v: View) {
        nav?.navigate(R.id.action_aboutYouFragment_to_photoFragment)
    }
